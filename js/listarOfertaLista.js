                        ...
                        <div class="space-y-2">
                            ...
                            ${hasMoreMaterials ? `
                                <div class="text-center">
                                    <button onclick="window.offerListsManager.showAllMaterials(${offerList.id})" 
            ...
            modal.innerHTML = `
                <div class="bg-gray-800 rounded-lg p-6 max-w-3xl w-full max-h-[80vh] overflow-y-auto">
                    <div class="flex justify-between items-start mb-4">
                        <h2 class="text-2xl font-bold text-white">Lista de Ofertas #${offerList.id}</h2>
                    ...
                    <div class="flex items-center text-green-400 font-semibold text-lg mb-4">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-3">
                        <h4 class="text-sm font-medium text-gray-300 mb-2">Todos os Materiais (${offerList.ofertas.length}):</h4>
